...
public class FtpConnectorTests extends SystemTestCase {

	private FtpConnector ftp = null;

	private String user = DbProperties.FTP_USER.getValue();

	private String pass = DbProperties.FTP_PASSWORD.getValue();

	private String host = DbProperties.FTP_HOST.getValue();
	...
	public void testGetListOfFolders() throws Exception {
		long t = System.currentTimeMillis();
		String[] fileName = new String[] { (t++) + ".txt", (t++) + ".bin" };
		String folderName = "f_" + (t++);
